...
const BarChart = ({ data, labelKey, valueKey, label, isDarkMode }) => {
    ...
    chartInstance.current = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          label: label,
          data: values,
          backgroundColor: isDarkMode ? 'rgba(26, 143, 227, 0.7)' : 'rgba(10, 110, 189, 0.7)',
          borderColor: isDarkMode ? 'rgba(26, 143, 227, 1)' : 'rgba(10, 110, 189, 1)',
          borderWidth: 1
        }]
      },
      options: {
